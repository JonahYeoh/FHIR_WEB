...
function post_patient() {//submit button
    var patient = {
        "resourceType": "Patient",//data type
        "id": "ax98234",//data id
        "text": {
            "status": "generated"
        },
    ...
    patient.id = get_text_value("passport_number");//getting value from passport input slot
    ...
    var url = "http://hapi.fhir.org/baseR4/Patient/" + patient.id;
